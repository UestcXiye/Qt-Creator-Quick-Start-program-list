...
int StringListModel::rowCount(const QModelIndex&) const { return stringList.count(); }
...
// 设置支持放入动作
Qt::DropActions StringListModel::supportedDropActions() const { return Qt::CopyAction | Qt::MoveAction; }
